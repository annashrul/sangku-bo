                    ...
                    <div className="row">
                        ...
                        */}
                        <div className="col-md-4">
                            <h6 style={{marginTop:'20px'}}>Step01</h6>
                            <div className='form-group'>
                                    <label>Judul <button className="badge badge-success" onClick={(event)=>this.handleBtnSubmit(event,'step01_title')}>Simpan</button></label>
                                    <div className="input-group mb-3">
                                        <div className="input-group-prepend">
                                            <span className="input-group-text" id="basic-addon4"><i className="fa fa-building"/></span>
                                        </div>
                            ...
                            <div className='form-group'>
                                <label>Gambar <button className="badge badge-success" onClick={(event)=>this.handleBtnSubmit(event,'step01_gambar')}>Simpan</button></label>
                            ...
                            <div className='form-group'>
                                <label>Deskripsi <button className="badge badge-success" onClick={(event)=>this.handleBtnSubmit(event,'step01_deskripsi')}>Simpan</button></label>
                                <Editor
                                    toolbarHidden
                        ...
                        <div className="col-md-4">
                            <h6 style={{marginTop:'20px'}}>Step02</h6>

                            <div className='form-group'>
                                    <label>Judul <button className="badge badge-success" onClick={(event)=>this.handleBtnSubmit(event,'step02_title')}>Simpan</button></label>
                                    <div className="input-group mb-3">
                                        <div className="input-group-prepend">
                                            <span className="input-group-text" id="basic-addon4"><i className="fa fa-building"/></span>
                                        </div>
                            ...
                            <div className='form-group'>
                                    <label>Gambar <button className="badge badge-success" onClick={(event)=>this.handleBtnSubmit(event,'step02_gambar')}>Simpan</button></label>
                                    <File64 multiple={ false }
                                            maxSize={2048} //in kb
                                            fileType='png, jpg' //pisahkan dengan koma
                                            className="mr-3 form-control-file"
                            ...
                            <div className='form-group'>
                                <label>Deskripsi <button className="badge badge-success" onClick={(event)=>this.handleBtnSubmit(event,'step02_deskripsi')}>Simpan</button></label>
                                <Editor
                                    toolbarHidden
                        ...
                        <div className="col-md-4">
                            <h6 style={{marginTop:'20px'}}>Step03</h6>

                            <div className='form-group'>
                                    <label>Judul <button className="badge badge-success" onClick={(event)=>this.handleBtnSubmit(event,'step03_title')}>Simpan</button></label>
                                    <div className="input-group mb-3">
                                        <div className="input-group-prepend">
                                            <span className="input-group-text" id="basic-addon4"><i className="fa fa-building"/></span>
                                        </div>
                            ...
                            <div className='form-group'>
                                    <label>Gambar <button className="badge badge-success" onClick={(event)=>this.handleBtnSubmit(event,'step03_gambar')}>Simpan</button></label>
                                    <File64 multiple={ false }
                                            maxSize={2048} //in kb
                                            fileType='png, jpg' //pisahkan dengan koma
                                            className="mr-3 form-control-file"
                            ...
                            <div className='form-group'>
                                <label>Deskripsi <button className="badge badge-success" onClick={(event)=>this.handleBtnSubmit(event,'step03_deskripsi')}>Simpan</button></label>
                                <Editor
                                    toolbarHidden
