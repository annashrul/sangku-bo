...
class FormMemberBank extends Component{
    ...
    handleSubmit(e){
        ...
        if(parseDetail['acc_name']===''||parseDetail['acc_name']===undefined){
            err = Object.assign({}, err, {full_name:"Nama lengkap tidak boleh kosong"});
            this.setState({confirm:false, error: err});
        }
        else if(parseDetail['bank_name']===''||parseDetail['bank_name']===undefined){
            err = Object.assign({}, err, {bank_name:"Nama Bank belum dipilih!"});
            this.setState({confirm:false, error: err});
        }
        else if(parseDetail['acc_no']===''||parseDetail['acc_no']===undefined){
    ...
    render(){
        ...
        return (
            <WrapperModal isOpen={this.props.isOpen && this.props.type === "formMemberBank"} size="lg">
                <ModalHeader toggle={this.toggle}>{this.props.detail.id===''?"Tambah Member Bank":"Ubah Member Bank"}</ModalHeader>
                <ModalBody>
                    <div className="row">
                        <div className="col-12">
                            ...
                            {/* <hr/> */}
                                ...
                                <div className="form-group">
                                    ...
                                    /> : <Skeleton style={{width:'100%',height:'40px'}}/> : <Skeleton style={{width:'100%',height:'40px'}}/>
                                    }
